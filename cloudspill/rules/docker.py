...
_SECRET_PATTERNS = [
    re.compile(r"(?i)(password|passwd|secret|token|api_key|apikey|access_key|private_key)"),
    re.compile(r"(?i)^(AWS_SECRET_ACCESS_KEY|AWS_ACCESS_KEY_ID|DATABASE_URL|DB_PASSWORD)$"),
